			...
			<Container className="pt-32 pb-20 md:pt-40">
				...
				<div className="flex flex-col gap-6">
					...
					<Text>
						...
						materiais (informações ou software) no site ProjectInBio , apenas
					...
					<ol className="list-decimal pl-8">
						...
						<Text as="li">
							...
							software contido no site ProjectInBio;
						</Text>
						<Text as="li">
					...
					<Text>
						...
						dessas restrições e poderá ser rescindida por ProjectInBio a
					...
					<ol className="list-decimal pl-8">
						<Text as="li">
							Os materiais no site da ProjectInBio são fornecidos &#39;como
							estão&#39;. ProjectInBio não oferece garantias, expressas ou
						...
						<Text as="li">
							Além disso, o ProjectInBio não garante ou faz qualquer
					...
					<Text>
						Em nenhum caso o ProjectInBio ou seus fornecedores serão
						...
						ProjectInBio, mesmo que ProjectInBio ou um representante autorizado
						da ProjectInBio tenha sido notificado oralmente ou por escrito da
					...
					<Text>
						Os materiais exibidos no site da ProjectInBio podem incluir erros
						técnicos, tipográficos ou fotográficos. ProjectInBio não garante que
						qualquer material em seu site seja preciso, completo ou atual.
						ProjectInBio pode fazer alterações nos materiais contidos em seu
						site a qualquer momento, sem aviso prévio. No entanto, ProjectInBio
					...
					<Text>
						O ProjectInBio não analisou todos os sites vinculados ao seu site e
						não é responsável pelo conteúdo de nenhum site vinculado. A inclusão
						de qualquer link não implica endosso por ProjectInBio do site. O uso
					...
					<Text>
						O ProjectInBio pode revisar estes termos de serviço do site a
					...
					<Text>
						...
						as leis do ProjectInBio e você se submete irrevogavelmente à
