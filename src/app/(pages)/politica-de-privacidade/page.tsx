		...
		<>
			...
			<Container className="pt-32 pb-20 md:pt-40">
				...
				<div className="flex flex-col gap-6">
					<Text>
						A sua privacidade é importante para nós. É política do ProjectInBio
					...
					<Text>
						...
						suas respectivas&nbsp;
						<Link
							href={`${env.NEXT_PUBLIC_APP_URL}/politica-de-privacidade`}
							className="underline"
						>
					...
					<Text>
						...
						informação que o ProjectInBio oferece no site e com caráter
					...
					<ol className="list-decimal pl-8">
						...
						<Text as="li">
							...
							xenofóbica, bets ou azar, qualquer tipo de pornografia ilegal, de
							apologia ao terrorismo ou contra os direitos humanos;
						</Text>

						<Text as="li">
							Não causar danos aos sistemas físicos (hardwares) e lógicos
							(softwares) do ProjectInBio, de seus fornecedores ou terceiros,
